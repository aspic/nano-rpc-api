...
import no.mehl.nano.auth.Authentication;
import no.mehl.nano.auth.HttpBasicAuth;
import no.mehl.nano.auth.HttpBearerAuth;
import no.mehl.nano.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://localhost:7076";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/19.0.0-alpha/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:7076
